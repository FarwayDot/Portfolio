# Portafolio de Diseño de Hardware - Jean F. R.R.

## :raised_hands: Introducción

Hola

Mi nombres es Jean Franco Requejo Rosales, Ingenierio Electrónico con el grado de Bachiller.

He participado en diversos proyectos de implementación electrónica, enfocado principalmente en el desarrollo de tarjetas electrónicas (PCBs 2-4 layers) utilizando sistemas embebidos.

Este apartado es un breve recopilatorio algunos proyectos realizados con anterioridad, indicando una breve descripción de los mismos.

## :book: Breve Descripción
...
[Linkedin Profile](https://www.linkedin.com/in/jean-franco-requejo-rosales-311266189)
